  ...
  <div>
    <div class="header-container">
      <nav class="flex w-full px-2">
        ...
        <div v-if="_isAuthentication" class="ml-auto flex items-center">
          <router-link :to="{ name: 'NewBookMarkiView' }" class="flex bg-gray-700 hover:bg-black text-white px-3 py-1 rounded-sm text-sm items-center mr-2">
